...
/* Voltage = (sample value/4096) * 5V   */
/* For millivolts ... */
/*  millivoltage = (sample value/4096) * 5000 mV   */
...
#define PHOTOCELL A1
/* Photocell resistance = 10 kohm * ((4096/sample value) - 1) */
...
float calculate_photocell_resistance(int sample_value)
{
  ...
  raw = (float)(sample_value);
  if(raw == 0.0) {raw = 0.5;}
  resistance = 10000.0 *((4096.0/raw)-1.0);
  return(resistance);
}
